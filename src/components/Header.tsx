      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex h-14 sm:h-16 items-center justify-between">
          ...
          <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
            ...
            <SheetContent 
              side="left" 
              className="w-[280px] sm:w-[340px] bg-gradient-to-br from-white via-white to-[#faf7f2] border-r border-gray-200 shadow-2xl"
            >
              {/* Header Section */}
              <div className="mb-8">
                ...
                <p className="text-sm text-gray-500 mt-1">Discover local talent</p>
              </div>
              ...
              <nav className="flex flex-col gap-1">
                ...
                <div className="mb-2">
                  ...
                  <Link 
                    href="/marketplace" 
                    className="flex items-center gap-3 text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all rounded-xl px-3 py-3 group"
                  ...
                  <>
                    ...
                    <div className="mb-2">
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 text-red-600 hover:text-red-700 hover:bg-red-50 transition-all rounded-xl px-3 py-3 group"
                      >
                  ...
                  <>
                    ...
                    <div className="space-y-3 px-3">
                      <button
                        ...
                        className="w-full text-center py-3 px-4 rounded-xl border-2 border-gray-900 text-gray-900 font-medium hover:bg-gray-900 hover:text-white transition-all"
                      >
                        Sign in
                      </button>
                      <button
            ...
            {status === 'loading' ? (
              ...
              <>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56 bg-white border-gray-200 hidden sm:block">
